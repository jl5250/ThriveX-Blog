...
export default () => {
  const data: MyData = {
    info: {
      ...
      introduction:
        '我从小就对计算机编程技术有着无穷的兴趣，所以我的梦想是做一名技术顶尖的 架构师，因此我一直在朝着这个方向去努力、去坚持 直到梦想成真！'
    },
    infoTwo: {
      author: 'loong',
      avatar_url: 'https://bucket.starlightpathserver.fun/blog/record/67e6d11ce4b0dcf86abf395f.jpg',
      left_tags: ['🤖️ 专研前端技术', '🔍 分享与热心帮助', '💻 前端工程师'],
      right_tags: ['源于热爱而发电 ✨', '开源项目作者 🥳', '热爱漫无边际 🎉'],
    ...
    character: [
      ...
      },
      {
        ...
        text2: '有远见',
        content:
          '有远见型的人非常富有想象力、思想开放并充满好奇心。他们重视原创性，专注于隐含的意义和遥远的可能性。',
        color: '#e4ae3a'
      },
      {
        value: 41,
    ...
    project: [
      {
        ...
        description:
          '🎉 ThriveX 相比旧版 Thrive 的核心改变是从 Vue 全面迁移到了 React 技术栈并采用了 Nextjs 服务端渲染技术进行全方面重构，对SEO方面有了显著的提高。并且还新增了很多额外的功能...',
        front: {
      ...
      },
      {
        ...
        description:
          '🎉 云上校园是一个现代化大学生社交平台，该项目的立意是为了打造一个完整的校园生态圈，使校园触手可及!',
        front: {
  ...
  return (
    <>
      ...
      <div
        className="bg-white dark:bg-black-a pt-20 bg-cover bg-center bg-fixed"
